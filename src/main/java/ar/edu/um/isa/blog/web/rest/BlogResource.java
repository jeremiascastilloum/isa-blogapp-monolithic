...
import ar.edu.um.isa.blog.domain.Blog;
import ar.edu.um.isa.blog.repository.BlogRepository;
...
/**
 * REST controller for managing {@link ar.edu.um.isa.blog.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
@Transactional
